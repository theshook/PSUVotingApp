...
public class ExecutiveVicePresidentActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_executive_vice_president);
    ...
    recyclerAdapter = new ExecutiveVicePresidentAdapter(partyLists, this);
  ...
  private void btnNextOnClick() {
    btnNext.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (ExecutiveVicePresidentAdapter._id.equals(null) || ExecutiveVicePresidentAdapter._id.equals("")) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialogInterface, int i) {
            ...
            final ProgressDialog pd = new ProgressDialog(ExecutiveVicePresidentActivity.this);
    ...
    db.collection("voter").document(voterDetails.getId())
            ...
            .addOnSuccessListener(new OnSuccessListener<Void>() {
              ...
              public void onSuccess(Void aVoid) {
                Toast.makeText(ExecutiveVicePresidentActivity.this, "Succesfully voted.", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(ExecutiveVicePresidentActivity.this, MainActivity.class);
