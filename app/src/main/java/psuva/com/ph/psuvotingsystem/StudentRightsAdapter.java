...
public class StudentRightsAdapter extends RecyclerView.Adapter<StudentRightsAdapter.ViewHolder> {
  ...
  public StudentRightsAdapter(List<PartyList> listItemList, Context context) {
