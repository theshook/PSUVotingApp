...
public class BusinessManagerAdapter extends RecyclerView.Adapter<BusinessManagerAdapter.ViewHolder> {
  ...
  public BusinessManagerAdapter(List<PartyList> listItemList, Context context) {
