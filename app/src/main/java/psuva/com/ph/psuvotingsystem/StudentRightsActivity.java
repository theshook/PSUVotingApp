...
public class StudentRightsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    recyclerAdapter = new StudentRightsAdapter(partyLists, this);
    ...
    Query presidentQuery = president.whereEqualTo("position", "VC for Student Rights and Welfare");
  ...
  private void btnNextOnClick() {
    btnNext.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (StudentRightsAdapter._id.equals(null) || StudentRightsAdapter._id.equals("")) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialogInterface, int i) {
            ...
            final ProgressDialog pd = new ProgressDialog(StudentRightsActivity.this);
    ...
    db.collection("voter").document(voterDetails.getId())
            ...
            .addOnSuccessListener(new OnSuccessListener<Void>() {
              ...
              public void onSuccess(Void aVoid) {
                Toast.makeText(StudentRightsActivity.this, "Succesfully voted.", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(StudentRightsActivity.this, MainActivity.class);
