...
public class ProjectAndActivitiesActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_project_and_activities);
    ...
    recyclerAdapter = new ProjectAndActivitiesAdapter(partyLists, this);
    ...
    Query presidentQuery = president.whereEqualTo("position", "VC for Project and Activities");
  ...
  private void btnNextOnClick() {
    btnNext.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (ProjectAndActivitiesAdapter._id.equals(null) || ProjectAndActivitiesAdapter._id.equals("")) {
          Toast.makeText(ProjectAndActivitiesActivity.this, "Kindly select to vote.", Toast.LENGTH_SHORT).show();
          return;
        }

        AlertDialog.Builder builder = new AlertDialog.Builder(ProjectAndActivitiesActivity.this);
        AlertDialog ad;
  ...
  private void updateVoter() {
    db.collection("voter").document(voterDetails.getId())
            .update("isVoted.vcpa", true)
            .addOnSuccessListener(new OnSuccessListener<Void>() {
              @Override
              public void onSuccess(Void aVoid) {
                Toast.makeText(ProjectAndActivitiesActivity.this, "Succesfully voted.", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(ProjectAndActivitiesActivity.this, MainActivity.class);

                Map<String, Boolean> isVoted = (Map<String, Boolean>) voterDetails.getIsVoted();

                if (isVoted.containsKey("vcpa")) {
                  isVoted.put("vcpa", true);
                }
