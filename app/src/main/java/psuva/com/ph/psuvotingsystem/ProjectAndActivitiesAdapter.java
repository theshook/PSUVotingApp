...
public class ProjectAndActivitiesAdapter extends RecyclerView.Adapter<ProjectAndActivitiesAdapter.ViewHolder> {
  ...
  public ProjectAndActivitiesAdapter(List<PartyList> listItemList, Context context) {
