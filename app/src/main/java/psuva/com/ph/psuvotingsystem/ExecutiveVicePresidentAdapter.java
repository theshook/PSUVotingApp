...
public class ExecutiveVicePresidentAdapter extends RecyclerView.Adapter<ExecutiveVicePresidentAdapter.ViewHolder> {
  ...
  public ExecutiveVicePresidentAdapter(List<PartyList> listItemList, Context context) {
