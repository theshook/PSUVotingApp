...
public class PublicRelationsOfficeActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_public_relations_office);
    ...
    recyclerAdapter = new PublicRelationsOfficeAdapter(partyLists, this);
    ...
    Query bmQuery = president.whereEqualTo("position", "Public Relations Office");
      ...
      public void onClick(View view) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface dialogInterface, int i) {
            ...
            final ProgressDialog pd = new ProgressDialog(PublicRelationsOfficeActivity.this);
